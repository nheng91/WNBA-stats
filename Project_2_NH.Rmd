...
Fail to reject $H_0$. There is not sufficient evidence to suggest that decade is a significant predictor of player efficiency rating.  **Reduced Model #3** will now be the working model and we will assume decade to be dropped for the remainder of the analysis.
